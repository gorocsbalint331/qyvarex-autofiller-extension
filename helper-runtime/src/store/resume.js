 ...
 * Resolved path: src/store/resume.js
 * Dependencies:
 *   ./autofill-diff -> 3L9SO  =>  src/store/autofill-diff.js
 *   ./cover-letter -> 71sWr  =>  src/store/cover-letter.js
 *   ./cover-letter-state -> 7Ks3y  =>  src/store/cover-letter-state.js
 *   ./profile -> 9omPD  =>  src/store/profile.js
 *   ./resume-autofill-ready -> gJ2PS  =>  src/store/resume-autofill-ready.js
 *   ./resume-init -> dbT6g  =>  src/store/resume-init.js
 *   ./resume-name -> 3Cm0K  =>  src/store/resume-name.js
 *   @parcel/transformer-js/src/esmodule-helpers.js -> cHUbl  =>  @parcel/transformer-js/src/esmodule-helpers.js
 *   @plasmohq/messaging -> 92GyB  =>  @plasmohq/messaging.js
 *   @plasmohq/storage -> 9RCRe  =>  @plasmohq/storage.js
 *   zustand -> ffRFv  =>  zustand.js
 *   ~api/autofill-info -> 3ZEEL  =>  src/api/autofill-info.js
 ...
 *   ~enums/jobs/resume -> 3lKd7  =>  src/enums/jobs/resume.js
 ...
 *   ~utils/jobright-agent-page -> c3KQJ  =>  src/utils/jobright-agent-page.js
 *   ~utils/resume-job-id -> 67Z8T  =>  src/utils/resume-job-id.js
