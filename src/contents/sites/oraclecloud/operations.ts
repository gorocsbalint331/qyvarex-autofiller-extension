...
async function e$(e) {
  ...
  t.click();
  let r = await observer.waitForCondition(() => "" === eA(e.value) && !eO(), {
    timeout: 3e3,
    interval: 50,
    observeTarget: document.body,
  });
...
function eB(e, t, r) {
  ...
  if (oracleAnswer.isOraclePhoneCountryCodeField(r)) {
    let e10 = eL(t),
      r2 = eL(n);
    return !!e10 && e10 === r2;
  }
...
async function eq(e, t, r) {
  return await observer.waitForCondition(() => eB(e, t, r), {
...
async function eU(e, t = 500, r = 10) {
  let n = 0,
    o2 = null;
  for (; !o2 && n < r;)
    !(o2 = xpath.getFirstOrderedNode(e)) && (await delay.delay(t), n++);
  return o2;
}
function eH(e) {
  return String(e ?? "")
...
async function eK(e, t, r) {
  ...
  if (i2 && !n.checked) {
    let e10 = eW(n);
    ((e10 || n).click(), await delay.delay(50));
  }
  if (!i2) return false;
  let a2 = await observer.waitForCondition(() => eG(n), {
    timeout: 1e3,
    interval: 50,
...
async function eJ(e, t) {
  ...
  for (let e10 of o2) {
    ...
    if (eI(t2, r, n)) {
      let t3 = xpath.getFirstOrderedNode("./ancestor::button", e10);
      (t3 &&
        !t3.classList.contains("cx-select-pill-section--selected") &&
        (t3.click(), await (0, delay.delay)(1e3)),
        (i2 = true));
    }
  }
  return i2;
...
async function eQ(e, t) {
  ...
  for (let e10 = 0; e10 < n.length; e10++) {
    ...
    if (l2 && t.includes(l2)) {
      ...
      (a2.click(), await delay.delay(200), (r = true));
    }
  }
}
async function eZ(e, t) {
  ...
  for (let e10 = 0; e10 < n.length && e10 < i2.length; e10++) {
    let t2 = o2[e10]?.textContent?.trim() || i2[e10],
      l2 = dateUtils.transFormDateNumberToEg(r, t2.toLowerCase());
    if (!l2 || "NaN" === l2) return false;
    let s2 = await fillSelectField(n[e10], l2);
    if (!s2) return false;
    ((a2 = true), await delay.delay(300));
  }
  return a2;
}
function e0(e) {
...
async function e2(e, t, r) {
  let n = () =>
    ...
    o2 = await observer.waitForCondition(() => n() || !e0(t), {
      timeout: 5e3,
      interval: 100,
      observeTarget: "undefined" != typeof document ? document.body : void 0,
    }),
  ...
  return (
    !i2 &&
      ...
      dom.triggerEvents(r, ["click"]),
      await observer.waitForCondition(() => !e0(t), {
        timeout: 5e3,
        interval: 100,
        observeTarget: "undefined" != typeof document ? document.body : void 0,
      })),
...
async function e3() {
  ...
  if (e) {
    ...
    return t
      ? (dom.triggerEvents(t, ["click"]),
        await observer.waitForCondition(() => !e0(t) && (!r || !e0(r)), {
          timeout: 5e3,
          interval: 100,
          observeTarget:
...
async function e8() {
  let e = e6("education");
  e && (e.click(), await delay.delay(100));
}
async function e9() {
  let e = e6("experience");
  e && (e.click(), await delay.delay(100));
...
function tr(e) {
  let t =
    ...
    r = t
      ...
      .join(" or ");
  return (
    xpath.getFirstOrderedNode(`//apply-flow-block[
...
async function tS(e, t) {
  ...
  if (!r) {
    let t2 = tb(e);
    if (!t2) return false;
    (dom.triggerEvents(t2, ["click"]), await delay.delay(400), (r = ty(e)));
  }
  if (!r) return false;
  let n = await fillSelectField(r, t);
  n ||
    (r.focus?.(),
    r.click?.(),
    el(r, t),
    ...
    await delay.delay(100));
  let o2 = tv(r, e);
  return !!o2 && (dom.triggerEvents(o2, ["click"]), await tw(e, r, t));
}
async function tE(e) {
  ...
  if (!r) return false;
  let n = 0;
  for (let e10 of t) (await tS(r, e10)) && ((n += 1), await delay.delay(200));
  return n > 0;
}
async function tx(e, t, r) {
  return tD("resume")
    ? await tR("resume", await answerMethods.fetchPdfAsBlob(e), t, r)
    : (console.warn(
...
function tk(e) {
  ...
  let r =
    ...
    xpath.getFirstOrderedNode(".//input[@type='file']", t);
  return r;
}
function tT(e) {
  let t = tA(e);
...
async function t_() {
  ...
  e &&
    (dom.triggerEvents(e, ["click", "mousedown", "mouseup"]), await delay.delay(200));
}
async function tL(e) {
  let t = tT(e);
  if (!t) return true;
  let r = tj(e);
  if (!r) return false;
  (dom.triggerEvents(r, ["click", "mousedown", "mouseup"]),
    r.click?.(),
    await delay.delay(150),
    await t_());
  let n = await observer.waitForCondition(() => !!tI(e), {
    timeout: 1e4,
    interval: 200,
    observeTarget: document.body,
  });
...
async function tR(e, t, r, n) {
  ...
  await observer.waitForCondition(() => !!tI(e) && !!tk(e), {
    timeout: 5e3,
    interval: 100,
    observeTarget: document.body,
  });
  ...
  let a2 = await observer.waitForCondition(() => !!tT(e), {
    timeout: 1e4,
    interval: 200,
    observeTarget: document.body,
  });
...
async function tO(e, t, r) {
  return tD("coverLetter")
    ? await tR("coverLetter", await answerMethods.fetchCoverLetterPdfAsBlob(e), t, r)
    : (console.warn(
...
async function tN(e, t, r = {}) {
  let n = oracleAnswer.resolveOracleCountryValue(e);
  if (!n) return false;
  let o2 =
    t || xpath.getFirstOrderedNode('.//input[@name="country" or @id="country-12"]');
  ...
  if (
    ...
    if (!e10) return false;
    if (!t) {
      let e11 = xpath.getFirstOrderedNode(
...
export {
  e8 as addEducation,
  e9 as addExperience,
  e3 as cancelEducation,
  e5 as cancelExperience,
  cleanEduAndExp,
  ensureOracleLinkRows,
  eX as fillCheckBoxesField,
  tN as fillCountry,
  eZ as fillDateField,
  tE as fillLanguages,
  eJ as fillListboxField,
  eQ as fillRadioGroupField,
  fillSelectField,
  tm as fillSkills,
  tM as findOracleCoverLetterInput,
  tP as hasOracleCoverLetterSlot,
  proceedOracleEmailGateStep,
  proceedOracleJobDetailToApply,
  e1 as saveEducation,
  e4 as saveExperience,
  tO as uploadCoverLetter,
  tx as uploadResume,
};
