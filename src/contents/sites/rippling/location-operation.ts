...
async function bootstrapRipplingGooglePlacesPredictionRequest(e, t, r = document, n = observer.waitForCondition) {
  let i2 = extractRipplingGooglePlacesPredictionRequest(r, t);
  return i2 || (e.focus({ preventScroll: true }), d(e, t), await n(() => !!extractRipplingGooglePlacesPredictionRequest(r, t), { timeout: 3e3, interval: 50, observeTarget: r.head ?? r.body }), d(e, ""), e.dispatchEvent(new Event("change", { bubbles: true })), extractRipplingGooglePlacesPredictionRequest(r, t));
}
