/**
 * Parcel module id: 9NB6K
 * Resolved path: @ant-design/cssinjs.js
 * Dependencies:
 *   @parcel/transformer-js/src/esmodule-helpers.js -> cHUbl  =>  @parcel/transformer-js/src/esmodule-helpers.js
 *   react -> 329PG  =>  react-reexport.js
 *
 * npm-backed (@ant-design/cssinjs). Generated by scripts/replace-antd-with-npm.mjs — do not hand-edit.
 * Shared with antd facade via e("@ant-design/cssinjs").
 */
...
// scripts/_antd-vendor-tmp/cssinjs-entry.mjs
var cssinjs_entry_exports = {};
__export(cssinjs_entry_exports, {
...
module.exports = __toCommonJS(cssinjs_entry_exports);
...
var React = __toESM(__jrReq("react"));
...
var React2 = __toESM(__jrReq("react"));
...
var React6 = __toESM(__jrReq("react"));

// node_modules/rc-util/es/hooks/useLayoutEffect.js
var React3 = __toESM(__jrReq("react"));
...
var React4 = __toESM(__jrReq("react"));
...
var React5 = __toESM(__jrReq("react"));
...
var React7 = __toESM(__jrReq("react"));
...
var logicalPropertiesLinter_default = linter3;
...
var parentSelectorLinter_default = linter7;
      ...
      Object.keys(mergedStyle).forEach(function(key) {
        ...
        if (_typeof(value) === "object" && value && (key !== "animationName" || !value._keyframe) && !isCompoundCSSProperty(value)) {
          ...
          let appendStyle = function(cssKey, cssValue) {
            if (false) {
              [contentQuotesLinter_default, hashedAnimationLinter_default].concat(_toConsumableArray(linters)).forEach(function(linter9) {
                return linter9(cssKey, cssValue, {
                  path,
                  hashId,
                  parentSelectors
                });
...
function useStyleRegister(info, styleFn) {
  ...
  return function(node2) {
    ...
    if (!ssrInline || isMergedClientSide || !defaultCache) {
      styleNode = /* @__PURE__ */ React7.createElement(Empty, null);
    } else {
      styleNode = /* @__PURE__ */ React7.createElement("style", _extends({}, _defineProperty(_defineProperty({}, ATTR_TOKEN, cachedTokenKey), ATTR_MARK, cachedStyleId), {
        dangerouslySetInnerHTML: {
          __html: cachedStyleStr
        }
      }));
    }
    return /* @__PURE__ */ React7.createElement(React7.Fragment, null, styleNode, node2);
  };
}
...
var useCSSVarRegister = function useCSSVarRegister2(config, fn) {
  var key = config.key, prefix = config.prefix, unitless = config.unitless, ignore = config.ignore, token2 = config.token, _config$scope = config.scope, scope = _config$scope === void 0 ? "" : _config$scope;
...
function extractStyle(cache, options) {
  var _ref = typeof options === "boolean" ? {
    plain: options
  } : options || {}, _ref$plain = _ref.plain, plain = _ref$plain === void 0 ? false : _ref$plain, _ref$types = _ref.types, types = _ref$types === void 0 ? ["style", "token", "cssVar"] : _ref$types, _ref$once = _ref.once, once = _ref$once === void 0 ? false : _ref$once;
