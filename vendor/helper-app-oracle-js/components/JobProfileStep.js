 ...
 * Resolved path: components/JobProfileStep.js (oracle restore)
 * Dependencies:
 *   @parcel/transformer-js/src/esmodule-helpers.js -> cHUbl  =>  @parcel/transformer-js/src/esmodule-helpers.js
 *   @plasmohq/messaging -> 92GyB  =>  @plasmohq/messaging.js
 *   antd -> 9tniX  =>  antd.js
 *   clsx -> jgTfo  =>  clsx.js
 *   data-base64:~assets/images/credits.svg -> 6rd7Q  =>  data-base64__tilde_assets/images/credits.svg.js
 *   lodash-es -> p4RBe  =>  lodash-es.js
 *   react -> 329PG  =>  react-reexport.js
 *   react/jsx-runtime -> 8iOxN  =>  react/jsx-runtime.js
 *   ~api/env-resolver -> 45ABC  =>  _tilde_api/env-resolver.js
 *   ~components/ExternalJob/ExternalJobAnalyzing -> iJxrg  =>  _tilde_components/ExternalJob/ExternalJobAnalyzing.js
 *   ~components/ExternalJob/ExternalJobEntry -> 2GxpS  =>  _tilde_components/ExternalJob/ExternalJobEntry.js
 *   ~components/ExternalJob/ExternalJobFail -> 4koZP  =>  _tilde_components/ExternalJob/ExternalJobFail.js
 *   ~components/ExternalJob/ExternalJobForm -> 30xAs  =>  _tilde_components/ExternalJob/ExternalJobForm.js
 *   ~components/FillProgress -> iqFDb  =>  _tilde_components/FillProgress.js
 *   ~components/JobCard -> hh9tB  =>  _tilde_components/JobCard.js
 *   ~components/JobProfileStep/myworkday-progress -> dzqGl  =>  _tilde_components/JobProfileStep/myworkday-progress.js
 *   ~components/JobProfileStep/resolve-job-to-show -> knAUl  =>  _tilde_components/JobProfileStep/resolve-job-to-show.js
 *   ~components/LoadingButton -> 3KGxk  =>  _tilde_components/LoadingButton.js
 *   ~components/NextPageButton -> cb8Df  =>  _tilde_components/NextPageButton.js
 *   ~components/Popups/AutofillErrorModal -> 7ej6w  =>  _tilde_components/Popups/AutofillErrorModal.js
 *   ~components/Popups/DoubleConfirmPopup -> heASZ  =>  _tilde_components/Popups/DoubleConfirmPopup.js
 *   ~components/Popups/OutofCreditModal -> jMDeX  =>  _tilde_components/Popups/OutofCreditModal.js
 *   ~components/Popups/ResumeMissingKeyPopup -> zWHj6  =>  _tilde_components/Popups/ResumeMissingKeyPopup.js
 *   ~components/ResumeSwitcher -> ihewf  =>  _tilde_components/ResumeSwitcher.js
 *   ~components/UpdateJobInfoLink -> fDGTw  =>  _tilde_components/UpdateJobInfoLink.js
 *   ~components/VersionUpdate -> 8WhUc  =>  _tilde_components/VersionUpdate.js
 ...
 *   ~contents/pre-autofill-flow/tracking -> 3L3xh  =>  _tilde_contents/pre-autofill-flow/tracking.js
 *   ~core/pagenation -> l1kUK  =>  _tilde_core/pagenation.js
 *   ~hooks/usePaginationObserver -> 7xg1Q  =>  _tilde_hooks/usePaginationObserver.js
 *   ~hooks/usePreAutofillFlowRunner -> 62ozi  =>  _tilde_hooks/usePreAutofillFlowRunner.js
 *   ~hooks/useRegisterAgentCancel -> l5wRD  =>  _tilde_hooks/useRegisterAgentCancel.js
 *   ~hooks/useRegisterAgentSkip -> anm6s  =>  _tilde_hooks/useRegisterAgentSkip.js
 *   ~hooks/useStartAutofill -> 12lb0  =>  _tilde_hooks/useStartAutofill.js
 *   ~hooks/useSubmitApplication -> clZg3  =>  _tilde_hooks/useSubmitApplication.js
 *   ~hooks/useUpdateAgentResume -> e52YT  =>  _tilde_hooks/useUpdateAgentResume.js
 *   ~hooks/useUpdateCoverLetter -> lTWHp  =>  _tilde_hooks/useUpdateCoverLetter.js
