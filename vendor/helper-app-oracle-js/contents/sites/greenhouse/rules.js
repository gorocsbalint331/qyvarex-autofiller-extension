 ...
 * Resolved path: contents/sites/greenhouse/rules.js (oracle restore)
 * Dependencies:
 *   ../education-item-trace -> j7UGI  =>  _tilde_contents/sites/education-item-trace.js
 *   ./field-labels -> awNtS  =>  field-labels.js
 *   ./race -> cQ4Jg  =>  race.js
 *   ./rule-options -> k315S  =>  rule-options.js
 *   ./select-labels -> dy7Jk  =>  select-labels.js
 *   ./snapshot-alignment -> ewjev  =>  _tilde_contents/sites/greenhouse/snapshot-alignment.js
