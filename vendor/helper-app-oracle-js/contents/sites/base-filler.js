 ...
 * Resolved path: contents/sites/base-filler.js (oracle restore)
 * Dependencies:
 *   ./autofill-answer-pair-tracking -> aCElZ  =>  _tilde_contents/sites/autofill-answer-pair-tracking.js
 *   ./falcon-answer-tracking -> 2vI9E  =>  _tilde_contents/sites/falcon-answer-tracking.js
 *   ./falcon-response-accumulator -> 9lWmK  =>  _tilde_contents/sites/falcon-response-accumulator.js
 ...
 *   ~contents/methods/runtime-error -> cYBXq  =>  _tilde_contents/methods/runtime-error.js
 ...
 *   ~utils/starRating -> imWVP  =>  _tilde_utils/starRating.js
 *   ~utils/string -> ijEFi  =>  _tilde_utils/string.js
 */

var n = e("@parcel/transformer-js/src/esmodule-helpers.js");
n.defineInteropFlag(r), n.export(r, "getComboQuestionRuleKey", () => E), n.export(r,
    "getNewComboQuestionRules", () => x), n.export(r, "waitForComboQuestionsToSettle", () => C), n
  .export(r, "getAnswerRegular", () => k), n.export(r, "mergeComboQuestionAnswer", () => I), n
  .export(r, "BaseFiller", () => j);
var o = e("~contents/shared/filler"),
  ...
  u = e("~contents/methods/runtime-error"),
  c = e("~contents/methods/track"),
  d = e("~core/enums"),
  f = e("~core/xpath"),
  p = e("~enums/http"),
  m = e("~store/url"),
  h = e("~utils/fieldLabel"),
  g = e("~utils/starRating"),
  b = e("~utils/string"),
  y = e("./autofill-answer-pair-tracking"),
  v = e("./falcon-answer-tracking"),
  w = e("./falcon-response-accumulator");
...
function E(e) {
  let t = (0, h.normalizeFieldLabel)(e?.label);
  if (!t) return "";
  let r = S(e.$input),
    n = S(e.$label);
...
async function C(e, t = 0, r = e) {
  ...
  }) : n > 0 && await new Promise(e => setTimeout(e, n)), (0, a.checkpoint)()
}

function A(e) {
  return e ? new Set(e.map(e => (0, h.normalizeFieldLabel)(e.label))) : null
}

function k(e, t) {
  let r = e?.regular && "object" == typeof e.regular && !Array.isArray(e.regular) ? e.regular : {},
    n = A(t);
  return n ? Object.fromEntries(Object.entries(r).filter(([e]) => n.has((0, h.normalizeFieldLabel)(
    e)))) : r
}
...
function T(e, t) {
  let r = Array.isArray(e?.fillDataList) ? e.fillDataList : [],
    n = A(t);
  return n ? r.filter(e => n.has((0, h.normalizeFieldLabel)(e?.name))) : r
}
...
function I(e, t, r) {
  if (!e) return r ? (0, v.inheritFalconResponseAnswerMarker)({
    ...t,
    regular: k(t, r),
    fillDataList: T(t, r)
  }, t) : t;
...
class j {
  constructor() {
    this.coverLetterFillTask = null, this.hasComboQuestions = !1, this
      ...
      new o.TaskQueue, this.fillCancel = (0, a.createCancellation)(() => this.taskQueue.clear(),
        this.progressTracker.setCurrentField), this.cancel = this.fillCancel.cancel, this.skip =
      this.fillCancel.skip, this.createOperationHandler = (0, i.createOperationHandlerFactory)(
  ...
  async requestFormAnswers(e, t, r = {}) {
    try {
      this.token || (this.token = await (0, i.getSiteToken)()), !1 !== r.updateTimeTrace && (this
        .timeTrace.requestStartTime = Date.now());
      let n = this.captureFalconResponseRun(),
        o = await (0, i.getElementRules)(e, this.getSiteName(), this.token, t, this.resumeInfo.id,
          this.resumeInfo.tailorId, this.getElementRulesRequestUrl());
      return this.recordFalconResponse(o, n), !1 !== r.updateTimeTrace && (this.timeTrace
      ...
      if ((0, u.isExtensionContextInvalidatedError)(e)) return (0, c.sendHttpStatusMessage)(p
  ...
  async fillRegularFields(e) {
    let t = [...(0, i.getRegularOperations)((0, l.withoutCoverLetterRules)(e), this.answer
    ...
    let o = null,
      i = async e => {
          ...
          let l = this.getAdditionalSubmitSnapshotData?.() || {},
            s = (0, y.buildFalconAutofillAnswerPairData)(this
            .getFalconResponseAnswerForTracking()),
            u = {
              ...s ? {
                falcon: s
          ...
          (0, y.sendAutofillAnswerPairEvent)(p), t = F(p.submitSnapshot), r = F(p
            .additionalSubmitData || {}), n = i || n, (0, g.handleSubmitStarRating)(this
  ...
  async finalizeFillForm() {
    return (0, c.postStatus)("filling", this.progressTracker.fieldStatus, this.timeTrace), window
